...
export default class Lancamento extends React.Component {
    ...
    state = {
        ...
        despesa: { nome: "Selecione uma despesa", icone: require('../assets/iconCarrinho.png') },

        ativoModalConta: false,
        conta: { nome: "Selecione uma conta", icone: require('../assets/iconCofre.png') },
        ...
        return (
            <Modal
                ...
                <View style={[styles.container, { backgroundColor: "#dee4ed" }]}>
                    <Text style={{ marginTop: 20, fontWeight: "bold" }}>LANÇAR DESPESA</Text>
                    ...
                    <View style={styles.SectionStyle}>
                        <Image source={require("../assets/iconCalendario.png")} style={styles.ImageStyle} />
                        <TouchableOpacity style={{
                            height: 50,
                            borderRadius: 10,
                            marginTop: 33,
                            ...
                            <View ><Text>{this.state.dataDaDespesa.valor}</Text></View>
                        </TouchableOpacity>

                    </View>

                    <View style={styles.SectionStyle}>
                        <Image source={require("../assets/iconNota.png")} style={styles.ImageStyle} />
